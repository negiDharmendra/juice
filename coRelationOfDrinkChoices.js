d3.json('/drinkChoiceMatrix.json', function(err, json) {
    var visual = document.getElementById("visual");

    // persons moving between Marin, Sonoma, Napa, SF, EB, SV and other regions
    var matrix = json.slice(7,20);

    var array = ["Amla","Apple","Banana","Banana Shake","Black Jeera Masala Soda","Butter Fruit","Cucumber","Custard Apple","Fruits","Ginger Lime","Ginger Mint Lime","Grape","Jal Jeera Soda","Kokum","Lime","Mint Lime","Mix Fruit","Mosambi","Musk Melon","Orange","Papaya","Pineapple","Salt Lime Soda","Sapota","Soda","Strawberry milk shake","Sweet & Salt Lime Soda","Sweet Lime Soda","Water Melon","apple","banana"]
    array = array.slice(2,20);
    var rotation = -0.7;
